...
public class DriverSettingsActivity extends AppCompatActivity {
    ...
    LatLng latLng = new LatLng(30.000, 60.000);
    String placeName = "";
    private Uri resultUri;

    private RadioGroup mRadioGroup;
    private static final String TAG = "DriverSettingsActivity";
...
//        mProfileImage = (ImageView) findViewById(R.id.profileImage);
        ...
        getUserInfo(autocompleteFragment);
...
//                Picasso.get().load()getName
    ...
    private void getUserInfo(final AutocompleteSupportFragment autocompleteFragment){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("placeName")!=null){
                        mProfileImageUrl = map.get("placeName").toString();
                        autocompleteFragment.setText(mProfileImageUrl);
                    }
                }
            }
