...
//    private EditText mEmail, mPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisteration = (TextView) findViewById(R.id.forRegistration);
        ...
        mRegisteration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.isEmpty() || password.isEmpty()){
                    Toast.makeText(CustomerLoginActivity.this, "Please Fill the text fields", Toast.LENGTH_SHORT).show();
                }else {
