        ...
        toolbar.setOnMenuItemClickListener(new android.support.v7.widget.Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.logOut){
                    Toast.makeText(DriverMapActivity.this, "logout", Toast.LENGTH_SHORT).show();
                    isLoggingOut = true;

                    disconnectDriver();
                    String user_id = mAuth.getCurrentUser().getUid();
                    DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(user_id);
                    current_user_db.child("UserSignIn").setValue("signOutDriver");
//
                    ...
                    Toast.makeText(DriverMapActivity.this, "setting", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(DriverMapActivity.this, DriverSettingsActivity.class);
                    startActivity(intent);
                }
                else if(item.getItemId() == R.id.history){
                    dialogShowForStock();
                   /* Toast.makeText(DriverMapActivity.this, "history", Toast.LENGTH_SHORT).show();
                ...
                .setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,int id) {
                                ...
                                message = moneyTransfer.getText().toString();
                                detail = description.getText().toString();

                                if(TextUtils.isEmpty(message) || TextUtils.isEmpty(detail)){
                                    Toast.makeText(DriverMapActivity.this, "Message not send due to empty fields!", Toast.LENGTH_SHORT).show();
                                }else {
                                    DatabaseReference data =FirebaseDatabase.getInstance().getReference().child("notifications");
                                    data.child("message_title").setValue(message);
                                    data.child("message_detail").setValue(detail);
                                }
